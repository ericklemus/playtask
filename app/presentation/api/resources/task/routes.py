...
from app.presentation.api.resources.task.dtos import TaskCreatePayload as TaskCreatePayloadDTO
from app.presentation.api.resources.task.dtos import TaskGetResponse as TaskGetResponseDTO
from app.presentation.api.resources.task.dtos import TaskCreateResponse as TaskCreateResponseDTO
...
async def task_get(
    ...
    return db.execute(
        select(TaskModel).where(TaskModel.uuid == uuid)
    ).scalar_one()
